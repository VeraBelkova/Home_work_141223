...
def copy_data():
    print('Из какого файла Вы хотите копировать данные?')
    data_first, data_second = print_data()
    number_file = int(input('Введите номер файла: '))
    ...
    if number_file == 1:
        ...
        n_stroki = int(input('Введите номер строки для копии: '))
        with open('data_first_variant.csv', 'r', encoding='utf-8') as file:
            with open('new_file.txt', 'w', encoding='utf-8') as file1:
                ...
                for stroka in text:
                    list_new.append(stroka)
                
                file1.write(list_new[n_stroki-1])
    else:
        print("Какую строку, вы хотите скопировать?")
        n_stroki = int(input('Введите номер строки для копии: '))
        with open('data_second_variant.csv', 'r', encoding='utf-8') as file:
